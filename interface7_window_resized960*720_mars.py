...
image_file_faces1 = Image.open('images/test.jpg')
...
image_file_faces2 = Image.open('images/test.jpg')
...
image_file_faces3 = Image.open('images/test.jpg')
...
image_file_faces4 = Image.open('images/test.jpg')
...
def ImportImage():
    ...
    name1 = text_face1.get("1.0", "end-1c")
    name2 = text_face1.get("1.0", "end-1c")
    name3 = text_face1.get("1.0", "end-1c")
    name4 = text_face1.get("1.0", "end-1c")
...
#buttons
OpenButton = tk.Button(frame22, text='Open', command = Openfile).place(x=60, y=15)
ImportButton = tk.Button(frame22, text='Import', command = ImportImage).place(x=60, y=55)
SearchButton = tk.Button(frame22, text='Search', command = SearchImage).place(x=60, y=95)
